...
# Constants
SOURCE_TABLE = 'biap-datainfra-gcp.ckp_stg_dev.daily_inbound_2024'
TARGET_TABLE_PASSED = 'biap-datainfra-gcp.ckp_dds.harvest'
TARGET_TABLE_ERROR = 'biap-datainfra-gcp.ckp_stg_dev.daily_inbound_2024_err'
